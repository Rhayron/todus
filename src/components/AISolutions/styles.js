...
export const Section = styled.section`
  ...
  /* subtle top-edge gradient to separate from Solutions above */
...
export const Img = styled.img`
  ...
  display: block;
  border-radius: 12px;
  /* organic fade: image bleeds into the dark bg at right & bottom edges */
...
/* ── Single feature card (like reference image) ──────────────────── */
